...
import endingSceneBuilder from "./ending.js";
...
async function createScene(canvas, engine) {
    ...
    const {effectPointLight, effectSpotLight, effectHemiLight} = BTLIB.createEffectLights(scene, player, boss);
    ...
    boss.sceneSpecificInit(sceneInfo);
    ...
    sceneInfo.gotoNextScene = function() {
        theSceneManager.gotoScene(endingSceneBuilder);
    }
